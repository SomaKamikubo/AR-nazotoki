...
class Nazo03SyncTest {
  ...
  init(engine){
    ...
    engine.createEntity('nazo03st-pl1-ent', 'nazo03st-player1-img', pl1Marker.id, [0,0,0], [-90,0,0]);
    engine.createEntity('nazo03st-pl2-ent', 'nazo03st-player2-img', pl2Marker.id, [0,0,0], [-90,0,0]);
  }
}
